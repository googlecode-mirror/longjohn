...
$titles ="CREATE TABLE titles (id MEDIUMINT NOT NULL AUTO_INCREMENT, PRIMARY KEY(id), name varchar(100),path varchar(255), category varchar(255), artist varchar(100))";
...
$insertstyle = "INSERT INTO style VALUES (1,'blue',1)";
